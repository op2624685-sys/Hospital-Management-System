...
class PatientServiceImplTest {
    ...
    private final PatientServiceImpl patientService = new PatientServiceImpl(patientRepository, userRepository, modelMapper, authUtil, refreshTokenService, entityManager);
