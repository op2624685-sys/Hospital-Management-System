          ...
          <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
            ...
            <button type="submit"
              ...
              {isSending ? (
                ...
                <svg className='relative z-10 w-4 h-4 text-[var(--background)] group-hover:text-[var(--primary-foreground)] transition-colors duration-300' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M12 19l9 2-9-18-9 18 9-2zm0 0v-8' />
                </svg>
              )}
              <span className={`relative z-10 text-[var(--background)] ${!isSending && 'group-hover:text-[var(--primary-foreground)]'} transition-colors duration-300`}>
