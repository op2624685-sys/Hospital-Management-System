  ...
  return (
    <div className=' p-5'>
      ...
      <div className='flex justify-center items-center m-10 px-30'>
        ...
        <div className='section-2 w-1/3 h-150 m-10 p-12'>
          ...
          <div className='form relative'>
            <form className='flex flex-col'>
              ...
              <input className='block w-full py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:text-white focus:border-blue-500 peer' type="text" name="doctor" id="doctor" />
              ...
              <input className='block w-full py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:text-white focus:border-blue-500 peer' type="text" name="patient" id="patient" />
              ...
              <input className='block w-full py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:text-white focus:border-blue-500 peer' type="date" name="date" id="date" />
              ...
              <input className='block w-full py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:text-white focus:border-blue-500 peer' type="time" name="time" id="time" />
